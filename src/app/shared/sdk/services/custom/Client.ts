...
export class ClientApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public clientOrderStats(id: any, relation: any, range: any, custom: any = {}, where: any = {}, groupBy: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/clients/:id/orders/stats";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof relation !== 'undefined' && relation !== null) _urlParams.relation = relation;
    if (typeof range !== 'undefined' && range !== null) _urlParams.range = range;
    if (typeof custom !== 'undefined' && custom !== null) _urlParams.custom = custom;
    if (typeof where !== 'undefined' && where !== null) _urlParams.where = where;
    if (typeof groupBy !== 'undefined' && groupBy !== null) _urlParams.groupBy = groupBy;
   ...
   * @param {object} custom {"start": date, "end": date }
   *
   * @param {object} where where filter orders
   *
   * @param {string} groupBy group by filter 
   *
   * @returns {object[]} An empty reference that will be
   ...
   * </em>
   */
  public clientIncomeStats(id: any, range: any, custom: any = {}, where: any = {}, groupBy: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/clients/:id/orders/income";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public clientStatsWrapper(id: any, range: any, custom: any = {}, where: any = {}, groupBy: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/clients/:id/stats";
    let _routeParams: any = {
